...
const PrequestionnairePhysical = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      FlowHelper.setVisited("PrequestionnairePhysical"); // Set the page as visited
  ...
  return (
    <div className="scale-container">
      <h3 className="text-2xl font-bold mb-6">Sie testen nun die Mauseinstellung mit adaptiver Unterstützung. Sie erhalten gleich weitere Informationen und die erforderlichen Sensoren. Wie erwarten Sie Ihre Performance im Gegensatz zu den anderen Mauseinstellungen?</h3>
...
export default PrequestionnairePhysical;

...
const PostQuestionnaireML = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      FlowHelper.setVisited("PostquestionnaireML");
  ...
  const scrollbarStyles = `
    ...
    .always-visible-scrollbar::-webkit-scrollbar-thumb {
      background-color: rgba(104, 86, 163, 0.7);
      border-radius: 4px;
    }
  ...
  return (
    <>
      ...
      <div className="always-visible-scrollbar" style={{ height: "80vh", padding: "50px", border: "1px solid #ccc", textAlign: "center" }}>
        <h2 className="text-3xl font-bold mb-8">Fragebogen zur Mauseinstellung (ML)</h2>
...
export default PostQuestionnaireML;
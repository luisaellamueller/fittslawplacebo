...
const PrequestionnaireStandard = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      FlowHelper.setVisited("PrequestionnaireStandard"); // Set the page as visited
  ...
  return (
    <div className="scale-container">
      <h3 className="text-2xl font-bold mb-6">Sie testen nun die Standard Mauseinstellung. Sie erhalten im Anschluss weitere Informationen und technische Details. Wie erwarten Sie Ihre Performance im Gegensatz zu den anderen Mauseinstellungen?</h3>
...
export default PrequestionnaireStandard;
